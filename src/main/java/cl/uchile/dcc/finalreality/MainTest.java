...
public class MainTest {
  ...
  public static void main(String[] args) throws InvalidStatValueException, InterruptedException {
    ...
    // Knights
    final PlayerCharacter knight1 = new Knight("1", 100, 50, queue);
    final PlayerCharacter knight2 = new Knight("1", 100, 50, queue);
    final PlayerCharacter knight3 = new Knight("2", 100, 50, queue);
    final PlayerCharacter knight4 = new Knight("1", 150, 50, queue);
    final PlayerCharacter knight5 = new Knight("1", 100, 100, queue);

    // Thiefs
    final PlayerCharacter thief1 = new Thief("1", 100, 50, queue);
    final PlayerCharacter thief2 = new Thief("1", 100, 50, queue);
    final PlayerCharacter thief3 = new Thief("2", 100, 50, queue);
    final PlayerCharacter thief4 = new Thief("1", 150, 50, queue);
    final PlayerCharacter thief5 = new Thief("1", 100, 100, queue);

    // Engineers
    final PlayerCharacter engineer1 = new Engineer("1", 100, 50, queue);
    final PlayerCharacter engineer2 = new Engineer("1", 100, 50, queue);
    final PlayerCharacter engineer3 = new Engineer("2", 100, 50, queue);
    final PlayerCharacter engineer4 = new Engineer("1", 150, 50, queue);
    final PlayerCharacter engineer5 = new Engineer("1", 100, 100, queue);

    // Black Mages
    final PlayerCharacter blackmage1 = new BlackMage("1", 100, 50, 100, queue);
    final PlayerCharacter blackmage2 = new BlackMage("1", 100, 50, 100, queue);
    final PlayerCharacter blackmage3 = new BlackMage("2", 100, 50, 100, queue);
    final PlayerCharacter blackmage4 = new BlackMage("1", 150, 50, 100, queue);
    final PlayerCharacter blackmage5 = new BlackMage("1", 100, 100, 100, queue);
    final PlayerCharacter blackmage6 = new BlackMage("1", 100, 50, 200, queue);

    // White Mages
    final PlayerCharacter whitemage1 = new WhiteMage("1", 100, 50, 100, queue);
    final PlayerCharacter whitemage2 = new WhiteMage("1", 100, 50, 100, queue);
    final PlayerCharacter whitemage3 = new WhiteMage("2", 100, 50, 100, queue);
    final PlayerCharacter whitemage4 = new WhiteMage("1", 150, 50, 100, queue);
    final PlayerCharacter whitemage5 = new WhiteMage("1", 100, 100, 100, queue);
    ...
    final Weapon sword2 = new Sword("1", 50, 20);
    final Weapon sword3 = new Sword("2", 50, 20);
    final Weapon sword4 = new Sword("1", 70, 20);
    final Weapon sword5 = new Sword("1", 50, 30);

    // Axes
    final Weapon axe1 = new Axe("1", 50, 20);
    final Weapon axe2 = new Axe("1", 50, 20);
    final Weapon axe3 = new Axe("2", 50, 20);
    final Weapon axe4 = new Axe("1", 70, 20);
    final Weapon axe5 = new Axe("1", 50, 30);

    // Bows
    final Weapon bow1 = new Bow("1", 50, 20);
    final Weapon bow2 = new Bow("1", 50, 20);
    final Weapon bow3 = new Bow("2", 50, 20);
    final Weapon bow4 = new Bow("1", 70, 20);
    final Weapon bow5 = new Bow("1", 50, 30);

    // Knifes
    final Weapon knife1 = new Knife("1", 50, 20);
    final Weapon knife2 = new Knife("1", 50, 20);
    final Weapon knife3 = new Knife("2", 50, 20);
    final Weapon knife4 = new Knife("1", 70, 20);
    final Weapon knife5 = new Knife("1", 50, 30);

    // Staffs
    final Weapon staff1 = new Staff("1", 50, 20, 50);
    final Weapon staff2 = new Staff("1", 50, 20, 50);
    final Weapon staff3 = new Staff("2", 50, 20, 50);
    final Weapon staff4 = new Staff("1", 70, 20, 50);
    final Weapon staff5 = new Staff("1", 50, 30, 50);
    final Weapon staff6 = new Staff("1", 50, 20, 100);
    ...
    if (!(knight1.equals(knight1))
      ...
      System.out.println("Method equals() worked correctly for Knight class\n");
    }
    ...
    if (!(engineer1.equals(engineer1))
      ...
      System.out.println("Method equals() worked correctly for Engineer class\n");
    }
    ...
    if (!(thief1.equals(thief1))
      ...
      System.out.println("Method equals() worked correctly for Thief class\n");
    }
    ...
    if (!(blackmage1.equals(blackmage1))
      ...
      System.out.println("Method equals() worked correctly for BlackMage class\n");
    }
    ...
    if (!(whitemage1.equals(whitemage1))
      ...
      System.out.println("Method equals() worked correctly for WhiteMage class\n");
    }
    ...
    if (!(enemy1.equals(enemy1))
      ...
      System.out.println("Method equals() worked correctly for Enemy class\n");
    }
    ...
    if (!(sword1.equals(sword1))
      ...
      System.out.println("Method equals() worked correctly for Sword class\n");
    }
    ...
    if (!(axe1.equals(axe1))
      ...
      System.out.println("Method equals() worked correctly for Axe class\n");
    }
    ...
    if (!(bow1.equals(bow1))
      ...
      System.out.println("Method equals() worked correctly for Bow class\n");
    }
    ...
    if (!(knife1.equals(knife1))
      ...
      System.out.println("Method equals() worked correctly for Knife class\n");
    }
    ...
    if (!(staff1.equals(staff1))
      ...
      System.out.println("Method equals() worked correctly for Satff class\n");
    }
    ...
    if (knight1.equals(engineer1)
      ...
      System.out.println("Method equals() worked correctly for objects of different classes\n");
    }

    System.out.println("-----Testing toString() methods and "
        + "equip() method (incomplete implementation)-----\n");
