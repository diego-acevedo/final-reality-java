package cl.uchile.dcc.finalreality.modelcontroller.controller;

import cl.uchile.dcc.finalreality.modelcontroller.controller.factories.character.AbstractCharacterFactory;
import cl.uchile.dcc.finalreality.modelcontroller.controller.factories.character.BlackMageFactory;
import cl.uchile.dcc.finalreality.modelcontroller.controller.factories.character.EngineerFactory;
import cl.uchile.dcc.finalreality.modelcontroller.controller.factories.character.KnightFactory;
import cl.uchile.dcc.finalreality.modelcontroller.controller.factories.character.ThiefFactory;
...
import cl.uchile.dcc.finalreality.modelcontroller.controller.player.Party;
import cl.uchile.dcc.finalreality.modelcontroller.controller.player.Player;
import cl.uchile.dcc.finalreality.modelcontroller.controller.states.GameState;
import cl.uchile.dcc.finalreality.modelcontroller.controller.states.Preparation;
...
public class GameDriver {
  ...
  /**
   * Set the action output to a new value. Often called when a
   * {@link PlayerCharacter player's character} completes an action.
   *
